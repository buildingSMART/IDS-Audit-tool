// <auto-generated/>
// This code was automatically generated with information from Xbim.Essentials 6.0.493.0.
...
public partial class SchemaInfo
{
    ...
    public static IEnumerable<IfcDataTypeInformation> AllDataTypes
    {
        get
        {
            yield return new IfcDataTypeInformation("IFCABSORBEDDOSEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCABSORBEDDOSEMEASURE","Absorbed radioactivity dose","gray","Gy","J / Kg","(2, 0, -2, 0, 0, 0, 0)","IfcUnitEnum.ABSORBEDDOSEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCALIGNMENTTYPEENUM", new[] { "Ifc4", "Ifc4x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCALIGNMENTVERTICALSEGMENTTYPEENUM", new[] { "Ifc4x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCAMOUNTOFSUBSTANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCAMOUNTOFSUBSTANCEMEASURE","Amount of substance","mole","mol","mol","(0, 0, 0, 0, 0, 1, 0)","IfcUnitEnum.AMOUNTOFSUBSTANCEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCAREAMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCAREAMEASURE","Area","square meter","","m2","(2, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.AREAUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCDOSEEQUIVALENTMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCDOSEEQUIVALENTMEASURE","Dose equivalent","sievert","Sv","J / Kg","(2, 0, -2, 0, 0, 0, 0)","IfcUnitEnum.DOSEEQUIVALENTUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCELECTRICCAPACITANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICCAPACITANCEMEASURE","Electric capacitance","farad","F","F","(-2, 1, 4, 1, 0, 0, 0)","IfcUnitEnum.ELECTRICCAPACITANCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCELECTRICCHARGEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICCHARGEMEASURE","Electric charge","coulomb","C","C","(0, 0, 1, 1, 0, 0, 0)","IfcUnitEnum.ELECTRICCHARGEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCELECTRICCONDUCTANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICCONDUCTANCEMEASURE","Electric conductance","siemens","S","S","(-2, -1, 3, 2, 0, 0, 0)","IfcUnitEnum.ELECTRICCONDUCTANCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCELECTRICCURRENTENUM", new[] { "Ifc2x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCELECTRICCURRENTMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICCURRENTMEASURE","Electric current","ampere","A","A","(0, 0, 0, 1, 0, 0, 0)","IfcUnitEnum.ELECTRICCURRENTUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCELECTRICRESISTANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICRESISTANCEMEASURE","Electric resistance","ohm","Ω","Ω","(2, 1, -3, -2, 0, 0, 0)","IfcUnitEnum.ELECTRICRESISTANCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCELECTRICTIMECONTROLTYPEENUM", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCELECTRICVOLTAGEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCELECTRICVOLTAGEMEASURE","Electric voltage","volt","V","V","(2, 1, -3, -1, 0, 0, 0)","IfcUnitEnum.ELECTRICVOLTAGEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCENERGYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCENERGYMEASURE","Energy","joule","J","J","(2, 1, -2, 0, 0, 0, 0)","IfcUnitEnum.ENERGYUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCFORCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCFORCEMEASURE","Force","newton","N","N","(1, 1, -2, 0, 0, 0, 0)","IfcUnitEnum.FORCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCFREQUENCYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCFREQUENCYMEASURE","Frequency","hertz","Hz","Hz","(0, 0, -1, 0, 0, 0, 0)","IfcUnitEnum.FREQUENCYUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCILLUMINANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCILLUMINANCEMEASURE","Illuminance","lux","lx","lx","(-2, 0, 0, 0, 0, 0, 1)","IfcUnitEnum.ILLUMINANCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCIMPACTPROTECTIONDEVICETYPEENUM", new[] { "Ifc4x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCINDUCTANCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCINDUCTANCEMEASURE","Inductance","henry","H","Wb / A","(2, 1, -2, -2, 0, 0, 0)","IfcUnitEnum.INDUCTANCEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCLENGTHMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCLENGTHMEASURE","Length","meter","m","m","(1, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.LENGTHUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCLUMINOUSFLUXMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCLUMINOUSFLUXMEASURE","Luminous flux","lumen","lm","lm","(0, 0, 0, 0, 0, 0, 1)","IfcUnitEnum.LUMINOUSFLUXUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCLUMINOUSINTENSITYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCLUMINOUSINTENSITYMEASURE","Luminous intensity","candela","cd","cd","(0, 0, 0, 0, 0, 0, 1)","IfcUnitEnum.LUMINOUSINTENSITYUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCMAGNETICFLUXDENSITYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCMAGNETICFLUXDENSITYMEASURE","Magnetic flux density","tesla","T","Wb / m2","(0, 1, -2, -1, 0, 0, 0)","IfcUnitEnum.MAGNETICFLUXDENSITYUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCMAGNETICFLUXMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCMAGNETICFLUXMEASURE","Magnetic flux","weber","Wb","Wb","(2, 1, -2, -1, 0, 0, 0)","IfcDerivedUnitEnum.MAGNETICFLUXUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCNONNEGATIVELENGTHMEASURE", new[] { "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCNONNEGATIVELENGTHMEASURE","Non negative length","meter","m","m","(1, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.LENGTHUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCNULLSTYLEENUM", new[] { "Ifc2x3", "Ifc4" }, "xs:string");
            ...
            yield return new IfcDataTypeInformation("IFCPLANARFORCEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPLANARFORCEMEASURE","Planar force","pascal","Pa","Pa","(-1, 1, -2, 0, 0, 0, 0)","IfcDerivedUnitEnum.PLANARFORCEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCPLANEANGLEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPLANEANGLEMEASURE","Angle","radian","rad","rad","(0, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.PLANEANGLEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCPOSITIVELENGTHMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPOSITIVELENGTHMEASURE","Positive length","meter","m","m","(1, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.LENGTHUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCPOSITIVEPLANEANGLEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPOSITIVEPLANEANGLEMEASURE","Positive plane angle","radian","rad","rad","(0, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.PLANEANGLEUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCPOSITIVERATIOMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, "xs:double");
            yield return new IfcDataTypeInformation("IFCPOWERMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPOWERMEASURE","Power","watt","W","W","(2, 1, -3, 0, 0, 0, 0)","IfcUnitEnum.POWERUNIT"), "xs:double");
            yield return new IfcDataTypeInformation("IFCPRESENTABLETEXT", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, "xs:string");
            yield return new IfcDataTypeInformation("IFCPRESSUREMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCPRESSUREMEASURE","Pressure","pascal","Pa","Pa","(-1, 1, -2, 0, 0, 0, 0)","IfcUnitEnum.PRESSUREUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCRADIOACTIVITYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCRADIOACTIVITYMEASURE","Radio activity","becqurel","Bq","Bq","(0, 0, -1, 0, 0, 0, 0)","IfcUnitEnum.RADIOACTIVITYUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCROTATIONALFREQUENCYMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCROTATIONALFREQUENCYMEASURE","Rotational frequency","hertz","Hz","Hz","(0, 0, -1, 0, 0, 0, 0)","IfcDerivedUnitEnum.ROTATIONALFREQUENCYUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCSOLIDANGLEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCSOLIDANGLEMEASURE","Solid angle","steradin","sr","sr","(0, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.SOLIDANGLEUNIT"), "xs:double");
            ...
            yield return new IfcDataTypeInformation("IFCSTRIPPEDOPTIONAL", new[] { "Ifc4", "Ifc4x3" }, "xs:boolean");
            ...
            yield return new IfcDataTypeInformation("IFCVOLUMEMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCVOLUMEMEASURE","Volume","cubic meter","","m3","(3, 0, 0, 0, 0, 0, 0)","IfcUnitEnum.VOLUMEUNIT"), "xs:double");
