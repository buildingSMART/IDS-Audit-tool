...
public partial class SchemaInfo
{
	private static readonly IfcDataTypeInformation[] _allDataTypes = [
		...
		new IfcDataTypeInformation("IFCSOUNDPOWERLEVELMEASURE", new[] { "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCSOUNDPOWERLEVELMEASURE","Sound power level (log ref. 1e-12 W)","decibel SWL","db","db","(0, 0, 0, 0, 0, 0, 0)","IfcDerivedUnitEnum.SOUNDPOWERLEVELUNIT"), "xs:double"),
		new IfcDataTypeInformation("IFCSOUNDPOWERMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCSOUNDPOWERMEASURE","Sound power","watt","W","W","(2, 1, -3, 0, 0, 0, 0)","IfcDerivedUnitEnum.SOUNDPOWERUNIT",new[] { "IfcSIUnitName.WATT" }), "xs:double"),
		new IfcDataTypeInformation("IFCSOUNDPRESSURELEVELMEASURE", new[] { "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCSOUNDPRESSURELEVELMEASURE","Sound pressure level (log ref. 2e-5 Pa)","decibel SPL","db","db","(0, 0, 0, 0, 0, 0, 0)","IfcDerivedUnitEnum.SOUNDPRESSURELEVELUNIT"), "xs:double"),
		new IfcDataTypeInformation("IFCSOUNDPRESSUREMEASURE", new[] { "Ifc2x3", "Ifc4", "Ifc4x3" }, new IfcMeasureInformation("IFCSOUNDPRESSUREMEASURE","Sound pressure","pascal","Pa","Pa","(-1, 1, -2, 0, 0, 0, 0)","IfcDerivedUnitEnum.SOUNDPRESSUREUNIT",new[] { "IfcSIUnitName.PASCAL" }), "xs:double"),
		...
		new IfcDataTypeInformation("IFCSTRIPPEDOPTIONAL", new[] { "Ifc4", "Ifc4x3" }, "xs:boolean"),
